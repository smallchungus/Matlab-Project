...
clear
%FILENAME = 'TestNewtonHorner1.txt';
%FILENAME = 'TestNewtonHorner2.txt';
%FILENAME = 'TestNewtonHorner3.txt';
%FILENAME = 'TestNewtonHorner4.txt';
FILENAME = 'TestNewtonHorner5.txt';
